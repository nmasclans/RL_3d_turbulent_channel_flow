...
t_episode_eval = 1.0
cfd_n_envs = 16         # num. cfd simulations run in parallel
...
###    "verbosity": "debug", # quiet, debug, info
    ...
    "replay_buffer_capacity": ( int(t_episode_train / t_action) + 1 ) * cfd_n_envs, # TODO: multiply by *(cfd_n_envs * rl_n_envs) ???    # trajectories buffer expand a full train episode
