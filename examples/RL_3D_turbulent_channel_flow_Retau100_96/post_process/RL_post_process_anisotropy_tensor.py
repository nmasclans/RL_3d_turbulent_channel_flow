...
for i_RL in range(n_RL):
    ...
    # Build frames
    frames_avg_u       = visualizer.build_um_frame(   frames_avg_u,  y_delta_RL, y_delta_ref, avg_u_RL[i_RL],  avg_u_ref,  averaging_time_nonConv, global_step_list[i_RL], ylim=[0.0, avg_u_max])
    frames_rmsf_u      = visualizer.build_urmsf_frame(frames_rmsf_u, y_delta_RL, y_delta_ref, rmsf_u_RL[i_RL], rmsf_u_ref, averaging_time_nonConv, global_step_list[i_RL], ylim=[0.0, rmsf_u_max])
