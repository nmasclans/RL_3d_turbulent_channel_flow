...
### Open data file
for iter in [3210000, 3320000, 3520000, 3620000, 3720000, 3820000, 3920000, 4020000, 4120000]:
    filename  = f'restart_data_file_{iter}.h5'
    print(f"\nFilename: {filename}")
    ...
    for i in range( 1, num_points_x-1 ):
        for j in range( 1, num_points_y-1 ):
            for k in range( 1, num_points_z-1 ):
                ...
                sum_u_volume += volume*u_data[k,j,i]
                sum_volume += volume
    U_b = sum_u_volume/sum_volume
    print( "U_bulk: ", U_b )
    #print( "L_x / U_bulk: ", L_x/U_b )
